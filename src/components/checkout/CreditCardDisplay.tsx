...
export default function CreditCardDisplay({
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-4">
      {/* Card Front */}
      <div className="relative w-full aspect-[1.586] rounded-xl shadow-2xl bg-gradient-to-br from-gray-700 to-gray-900 p-6 flex flex-col justify-between">
        <div>
      ...
      {/* Card Back */}
      <div className="relative w-full aspect-[1.586] rounded-xl shadow-2xl bg-gradient-to-br from-gray-600 to-gray-800 p-2 flex flex-col justify-start">
