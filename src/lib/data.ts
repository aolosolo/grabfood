...
export const foodItemsData: FoodItem[] = [
  ...
  { id: 'pizza-4', name: 'Hawaiian Breeze', description: 'Sweet pineapple chunks and savory ham for a tropical taste.', price: 13.49, category: 'pizza', imageUrl: 'https://images.unsplash.com/photo-1566843060200-a3a83523e134?q=80&w=600&h=400&auto=format&fit=crop', dataAiHint: 'hawaiian pizza', flavors: ['Classic Tomato'] },

  // Drinks
  { id: 'drink-1', name: 'Sparkling Cola', description: 'Crisp and refreshing cola, perfectly chilled.', price: 1.99, category: 'drinks', imageUrl: 'https://images.unsplash.com/photo-1624552184280-9e9631c38e28?q=80&w=300&h=200&auto=format&fit=crop', dataAiHint: 'cola drink' },
  ...
  // Sides
  { id: 'side-1', name: 'Golden Fries', description: 'Perfectly crispy, golden-brown french fries, lightly salted.', price: 3.49, category: 'sides', imageUrl: 'https://images.unsplash.com/photo-1630384060421-cb20d0e06399?q=80&w=400&h=300&auto=format&fit=crop', dataAiHint: 'french fries' },
  { id: 'side-2', name: 'Cheesy Garlic Breadsticks', description: 'Warm, fluffy breadsticks brushed with garlic butter and topped with melted mozzarella.', price: 4.99, category: 'sides', imageUrl: 'https://images.unsplash.com/photo-1604913281413-53a5b39912c2?q=80&w=400&h=300&auto=format&fit=crop', dataAiHint: 'garlic bread' },
