...
export const foodItemsData: FoodItem[] = [
  ...
  { id: 'drink-3', name: 'Artisan Iced Coffee', description: 'Smooth, cold-brewed coffee for a revitalizing boost.', price: 3.99, category: 'drinks', imageUrl: 'https://images.unsplash.com/photo-1747218622335-77b9bb8f76bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxhcnRpc2FuJTIwaWNlcyUyMGNvZmZlZXxlbnwwfHx8fDE3NTExMDA1NTJ8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'iced coffee' },
  ...
  { id: 'drink-5', name: 'Sprite Burst', description: 'Crisp, lemon-lime soda with a refreshing fizz.', price: 1.99, category: 'drinks', imageUrl: 'https://images.unsplash.com/photo-1527661591475-5273f2e10ebb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxzd2VldCUyMGljZWQlMjB0ZWF8ZW58MHx8fHwxNzUxMTAzMTc3fDA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'sprite drink' },
  ...
  { id: 'side-3', name: 'Crispy Onion Rings', description: 'Thick-cut onion rings, battered and fried to golden perfection.', price: 4.29, category: 'sides', imageUrl: 'https://images.unsplash.com/photo-1639024471283-03518883512d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxjcmlzcHklMjBvbmlvbiUyMHJpbmdzfGVufDB8fHx8MTc1MTEwMDIwM3ww&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'onion rings' },
  { id: 'side-4', name: 'Chicken Wings (6pcs)', description: 'Spicy and tangy chicken wings.', price: 7.99, category: 'sides', imageUrl: 'https://images.unsplash.com/photo-1600555379765-f82335a7b1b0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxjaGlja2VuJTIwd2luZ3N8ZW58MHx8fHwxNzUxMTAwMTc3fDA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'chicken wings' },
  ...
  { id: 'soup-2', name: 'Chicken Noodle Soup', description: 'Classic comforting chicken noodle soup.', price: 6.00, category: 'soups', imageUrl: 'https://images.unsplash.com/photo-1644083152667-2c78739e882a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw2fHxjaGlja2VuJTIwbm9vZGxlJTIwc291cHxlbnwwfHx8fDE3NTExMDAyNjR8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'chicken soup' },
];
